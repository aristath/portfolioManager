...
// Returns raw API response without transformation for metadata storage
func (a *TradernetBrokerAdapter) GetSecurityMetadataRaw(symbol string) (interface{}, error) {
