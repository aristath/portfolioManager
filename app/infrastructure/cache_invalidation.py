...
class CacheInvalidationService:
    ...
    def invalidate_recommendation_caches(
        ...
        logger.debug(f"Invalidated recommendation caches (limits: {limits}, strategies: {strategies})")
...
def get_cache_invalidation_service(cache: Optional[SimpleCache] = None) -> CacheInvalidationService:
    """
