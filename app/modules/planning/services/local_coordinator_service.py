    ...
    async def create_plan(self, request: CreatePlanRequest) -> CreatePlanResponse:
        ...
        gen_request = GenerateSequencesRequest(
            ...
            feasibility=FeasibilitySettings(
                ...
                transaction_cost_fixed=request.parameters.transaction_cost_fixed,
                transaction_cost_percent=request.parameters.transaction_cost_percent,
                priority_threshold=request.parameters.priority_threshold,
            ),
            combinatorial=CombinatorialSettings(
                max_depth=request.parameters.max_depth,
                max_opportunities_per_category=request.parameters.max_opportunities_per_category,
                priority_threshold=request.parameters.priority_threshold,
                combinatorial_max_combinations_per_depth=request.parameters.combinatorial_max_combinations_per_depth,
                combinatorial_max_sells=request.parameters.combinatorial_max_sells,
                combinatorial_max_buys=request.parameters.combinatorial_max_buys,
                combinatorial_max_candidates=request.parameters.combinatorial_max_candidates,
                enable_weighted_combinations=request.parameters.enable_combinatorial,
                enable_diverse_selection=request.parameters.enable_diverse_selection,
                diversity_weight=request.parameters.diversity_weight,
                enable_adaptive_patterns=request.parameters.enable_adaptive_patterns,
                enable_partial_execution=request.parameters.enable_partial_execution,
                enable_constraint_relaxation=request.parameters.enable_constraint_relaxation,
                enable_market_regime=request.parameters.enable_market_regime,
            ),
        ...
        async for batch in generator_client.generate_sequences_streaming(gen_request):
            ...
            eval_request = EvaluateSequencesRequest(
                ...
                settings=EvaluationSettings(
                    ...
                    transaction_cost_fixed=request.parameters.transaction_cost_fixed,
                    transaction_cost_percent=request.parameters.transaction_cost_percent,
                    cost_penalty_factor=request.parameters.cost_penalty_factor,
                    enable_multi_objective=request.parameters.enable_multi_objective,
                    enable_stochastic_scenarios=request.parameters.enable_stochastic_scenarios,
                    enable_monte_carlo=request.parameters.enable_monte_carlo,
                    monte_carlo_paths=request.parameters.monte_carlo_paths,
                    enable_multi_timeframe=request.parameters.enable_multi_timeframe,
                    enable_priority_sorting=request.parameters.enable_priority_sorting,
                ),
            )
