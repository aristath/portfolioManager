"""Scoring service REST API application."""
...
from services.scoring.routes import router
...
app = FastAPI(
    ...
    description="Security scoring service",
    version="1.0.0",
)
...
# Include router
app.include_router(router, prefix="/scoring", tags=["scoring"])


@app.on_event("startup")
async def startup_event():
    """Initialize service on startup."""
    logger.info("Scoring service starting up...")
