...
class TestExpectedReturnsCalculator:
    ...
    @pytest.mark.asyncio
    async def test_calculates_returns_with_cagr_and_score(self, calculator, mock_calc_repo, mock_score_repo, mock_stock_repo):
    ...
    @pytest.mark.asyncio
    async def test_applies_regime_adjustment(self, calculator, mock_calc_repo, mock_score_repo, mock_stock_repo):
        ...
        with patch(
            ...
            # Test default regime
            result_default = await calculator.calculate_expected_returns(symbols, regime=None)
            
            # Test bear regime (should reduce returns by ~25%)
            result_bear = await calculator.calculate_expected_returns(symbols, regime="bear")
    ...
    @pytest.mark.asyncio
    async def test_applies_dividend_bonus(self, calculator, mock_calc_repo, mock_score_repo, mock_stock_repo):
