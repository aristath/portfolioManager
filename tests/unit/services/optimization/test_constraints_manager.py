...
def create_stock(
    ...
    security.allow_buy = allow_buy
    security.allow_sell = allow_sell
    security.min_lot = min_lot
    security.country = country
    security.industry = industry
    security.min_portfolio_target = min_portfolio_target
    security.max_portfolio_target = max_portfolio_target
    return security
...
class TestWeightBoundsCalculation:
    """Test weight bounds calculation for individual securities."""

    def test_unconstrained_stock_gets_default_bounds(self):
        """Test that unconstrained security gets (0, max_concentration) bounds."""
        manager = ConstraintsManager()
        securities = [create_stock("AAPL")]
        positions = {}
        portfolio_value = 10000
        current_prices = {"AAPL": 150.0}

        bounds = manager.calculate_weight_bounds(
            securities, positions, portfolio_value, current_prices
        )
    ...
    def test_allow_buy_false_caps_upper_bound_at_current_weight(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", allow_buy=False)]
    ...
    def test_allow_sell_false_sets_lower_bound_to_current_weight(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", allow_sell=False)]
    ...
    def test_locked_position_both_bounds_equal_current_weight(self):
        """Test security with allow_buy=False and allow_sell=False is locked."""
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", allow_buy=False, allow_sell=False)]
    ...
    def test_min_lot_constraint_at_minimum_prevents_partial_sell(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", min_lot=5)]
    ...
    def test_new_position_zero_current_weight(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("NEWSTOCK")]
    ...
    def test_multiple_stocks_with_various_constraints(self):
        """Test calculating bounds for multiple securities with different constraints."""
        manager = ConstraintsManager()
        securities = [
...
class TestSectorConstraintsBuilding:
    ...
    async def test_geography_constraints_basic(self):
        ...
        # Since securities have "United States" and "Germany" but no grouping,
    ...
    async def test_none_country_grouped_as_other(self):
        """Test securities with None country are grouped as OTHER."""
        manager = ConstraintsManager()
        securities = [
            create_stock("AAPL", country="United States"),
    ...
    async def test_none_industry_grouped_as_other(self):
        """Test securities with None industry are grouped as OTHER."""
        manager = ConstraintsManager()
        securities = [
            create_stock("AAPL", industry="Consumer Electronics"),
    ...
    async def test_bounds_clamped_to_hard_caps(self):
        ...
        securities = [create_stock("AAPL", country="United States")]
    ...
    async def test_multiple_stocks_same_sector(self):
        """Test multiple securities in same sector are grouped correctly."""
        manager = ConstraintsManager()
        securities = [
            create_stock(
        ...
        # Consumer Electronics should contain all 3 securities
...
class TestEdgeCases:
    ...
    def test_very_large_min_lot(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", min_lot=1000000)]
        positions = {"AAPL": create_position("AAPL", 10, 1000)}
        portfolio_value = 10000
        current_prices = {"AAPL": 100.0}
    ...
    def test_conflicting_min_lot_and_allow_sell(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", allow_sell=False, min_lot=5)]
        positions = {"AAPL": create_position("AAPL", 10, 1000)}
        portfolio_value = 10000
        current_prices = {"AAPL": 100.0}
    ...
    def test_min_portfolio_target_applies_as_lower_bound(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", min_portfolio_target=5.0)]
        positions = {}
        portfolio_value = 10000
        current_prices = {"AAPL": 150.0}
    ...
    def test_max_portfolio_target_applies_as_upper_bound(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", max_portfolio_target=15.0)]
        positions = {}
        portfolio_value = 10000
        current_prices = {"AAPL": 150.0}
    ...
    def test_portfolio_targets_interact_with_allow_buy(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", allow_buy=False, max_portfolio_target=15.0)]
    ...
    def test_portfolio_targets_interact_with_allow_sell(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", allow_sell=False, min_portfolio_target=5.0)]
        # Current position: 10% of portfolio
        positions = {"AAPL": create_position("AAPL", 10, 1000)}
        portfolio_value = 10000
        current_prices = {"AAPL": 100.0}
    ...
    def test_portfolio_targets_interact_with_min_lot(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", min_lot=5, min_portfolio_target=5.0)]
        # Position at min_lot
        positions = {"AAPL": create_position("AAPL", 5, 1000)}
        portfolio_value = 10000
        current_prices = {"AAPL": 200.0}
    ...
    def test_portfolio_target_constraint_conflict_resolution(self):
        ...
        securities = [create_stock("AAPL", allow_sell=False, min_portfolio_target=15.0)]
...
class TestTargetNormalization:
    ...
    async def test_country_targets_normalized_when_sum_exceeds_100(self):
        ...
        # Note: Only countries with securities are considered for normalization
        country_targets = {
            "United States": 0.8,
            "Germany": 0.4,
            "France": 0.5,
    ...
    async def test_normalization_only_applies_to_active_industries(self):
        """Test normalization only considers industries that have securities."""
        manager = ConstraintsManager()
        securities = [
            create_stock("AAPL", industry="Technology"),
        ]
        # Technology has security, Energy doesn't
    ...
    async def test_normalization_only_applies_to_active_countries(self):
        """Test normalization only considers countries that have securities."""
        manager = ConstraintsManager()
        securities = [
            create_stock("AAPL", country="United States"),
        ]
        # United States has security, France doesn't
...
class TestIndustryConcentrationCapAdjustment:
    ...
    async def test_single_industry_gets_70_percent_cap(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", industry="Technology")]
...
class TestMinLotInfeasibleBounds:
    ...
    def test_min_lot_applied_when_within_bounds(self):
        ...
        manager = ConstraintsManager()
        securities = [create_stock("AAPL", min_lot=10, max_portfolio_target=30.0)]
